...
usage() {
  cat <<'USAGE'
Usage:
  quicksearch-dual.sh REPO_PATH [options]
...
Examples:
  quicksearch-dual.sh /work/grpc
  quicksearch-dual.sh /work/grpc --out /tmp/grpc-artifacts --duration 4h --top 10
USAGE
}
